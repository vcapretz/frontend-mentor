...
export default function ColumnPreviewCard() {
  return (
    <div className="min-h-screen flex items-center justify-center font-lexend">
      <Head>
      ...
      <div className="p-6 md:grid md:grid-cols-3 md:justify-center md:max-w-4xl md:mx-auto">
        <div className="rounded-t-lg md:rounded-t-none md:rounded-l-lg bg-[#e38826] p-8">
          <IconSedans />

          <h3 className="mt-4 uppercase text-[#f2f2f2] text-2xl font-big font-bold">
            Sedans
          </h3>
          ...
          <button className="mt-16 text-[#e38826] bg-[#f2f2f2] px-6 py-2 rounded-full hover:bg-[#e38826] hover:border-white border hover:text-white">
            Learn More
          </button>
        </div>

        <div className="bg-[#006970] p-8">
          <IconSuvs />
          ...
          <button className="mt-16 text-[#006970] bg-[#f2f2f2] px-6 py-2 rounded-full hover:bg-[#006970] hover:border-white border hover:text-white">
            Learn More
          </button>
        </div>

        <div className="rounded-b-lg md:rounded-b-none md:rounded-r-lg bg-[#004241] p-8">
          <IconLuxury />
          ...
          <button className="mt-16 text-[#004241] bg-[#f2f2f2] px-6 py-2 rounded-full hover:bg-[#004241] hover:border-white border hover:text-white">
            Learn More
          </button>
        </div>
      </div>
